...
%
\section{Durchfahrene Orte}%
\label{sec:DurchfahreneOrte}%
Kufstein, Vorderthiersee, Mitterland, Hinterthiersee, Landl, Schmiedtal, Vorderthiersee, Thiersee, Kufstein, Unterlangkampfen, Niederbreitenbach, Embach, Schönau, Breitenbach am Inn, Kramsach, Kundl, Breitenbach am Inn, Schönau, Achleit, Angath, Oberlangkampfen, Kirchbichl, Kufstein

%
\section{Diagramme}%
\label{sec:Diagramme}%
\subsection{Aktivitätsdiagramm{-}Abschlussprojekt}%
\label{subsec:Aktivittsdiagramm{-}Abschlussprojekt}%


\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth]{Aktivitätsdiagramm-Abschlussprojekt.png}%
\caption{Aktivitätsdiagramm{-}Abschlussprojekt}%
\end{figure}
...
%
\subsection{UML{-}Diagramm{-}Abschlussprojekt}%
\label{subsec:UML{-}Diagramm{-}Abschlussprojekt}%


\begin{figure}[H]%
\centering%
\includegraphics[width=0.95\textwidth]{UML-Diagramm-Abschlussprojekt.png}%
\caption{UML{-}Diagramm{-}Abschlussprojekt}%
\end{figure}
